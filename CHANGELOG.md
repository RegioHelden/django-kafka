...
- revert "fix: use the value first to obtain the lookup ID in ModelTopicConsumer.get\_lookup\_kwargs, refs \#338" [\#342](https://github.com/RegioHelden/django-kafka/pull/342) (@stefan-cardnell-rh)
